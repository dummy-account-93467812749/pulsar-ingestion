...
dependencies {
    ...
    implementation(project(":functions:translators:inventory-update-translator"))
    implementation(project(":functions:translators:order-record-translator"))
    implementation(project(":functions:translators:payment-notice-translator"))
    implementation(project(":functions:translators:shipment-status-translator"))
    implementation(project(":functions:translators:user-profile-translator"))

    implementation(project(":common")) // Common code, schemas
